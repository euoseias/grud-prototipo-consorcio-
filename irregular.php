...
$sql = "SELECT SUM(valor) AS \"situacao\" FROM consorcio WHERE situacao = \"Irregular\"";
 ...
 while ($registro = mysqli_fetch_array($resultado))
 {
   ...
   //echo "A SOMA DOS IRREGULAR R$".""."="."".$situacao;
  //echo $sql;
   //echo "</br></br>";
 }
 ?>
...
$sql = "SELECT * FROM consorcio WHERE situacao = 'Irregular'";
$resultado = mysqli_query($strcon,$sql) or die("Erro ao retornar dados");
 ...
 mysqli_close($strcon);
 echo "</table>";
//cho "<br><br><a href='cadastro.php'>Clique aqui para realizar uma consulta</a><br>";
